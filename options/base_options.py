...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--root', type=str, default='/rds/project/rds-LlrDsbHU5UM/sw991/Project_AD/data/ADNI-rawdata/', help='Train images path')
        ...
        parser.add_argument('--ndf', type=int, default=48, help='# of discrim filters in first conv layer')
